...
if __name__ == '__main__':
  train_data = read_data('data/yelp-2013-train.txt.ss')
  word_to_index = build_vocab(train_data[6], 'data/yelp-2013')
  process_and_save(word_to_index, train_data, 'data/yelp-2013-train.pkl')

  dev_data = read_data('data/yelp-2013-dev.txt.ss')
  process_and_save(word_to_index, dev_data, 'yelp-2013/imdb-dev.pkl')

  test_data = read_data('data/yelp-2013-test.txt.ss')
  process_and_save(word_to_index, test_data, 'data/yelp-2013-test.pkl')
